...
async function fetchVenuesFromBackend(): Promise<Tables<"venue_profiles">[]> {
...
return payload as Tables<"venue_profiles">[];
}

if (payload?.ok && Array.isArray(payload.data)) {
return payload.data as Tables<"venue_profiles">[];
}

throw new Error("Backend returned unexpected venue payload");
}
...
list.sort(
(a, b) =>
new Date(b.venue.created_at ?? 0).getTime() -
new Date(a.venue.created_at ?? 0).getTime()
);
